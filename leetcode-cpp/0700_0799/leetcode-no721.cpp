// problem:
// https://leetcode.cn/problems/accounts-merge/?envType=problem-list-v2&envId=3rBpGyas
#include <algorithm>
#include <iostream>
#include <ranges>
#include <set>
...
int main(int argc, char *argv[]) {
  Solution test;
  show_matrix(
  test.accountsMerge(temp_vector<vector<string>>(
  {{"John", "johnsmith@mail.com",
   ...
   {"Mary", "mary@mail.com"}})));
  cout << "[[ 'John', 'john00@mail.com', "
          "'john_newyork@mail.com', "
          "'johnsmith@mail.com' ], [ 'John', "
          "'johnnybravo@mail.com' ], [ 'Mary', "
          "'mary@mail.com' ]] ";
}
